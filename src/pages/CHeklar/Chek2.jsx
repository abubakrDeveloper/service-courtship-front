...
import Chek3 from "../CHeklar/Chek3";
...
const Chek2=()=> (
 <Splitter style={{ height: 600, boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)" }}>
        <Splitter.Panel defaultSize="40%" min="20%" max="60%">
              <div className="Chek mt-1.5 flex">
                <h2 className="text-2xl ml-3 text-emerald-600 text-shadow-lg/15">Chek 2 oynasi</h2>
                <Link className="ml-4 text-2xl flex" to="/Chek1">Chek 1
                <CiReceipt className="mt-1.5 ml-1" />
                </Link> 
                <Link className="ml-4 text-2xl flex" to="/Chek3">Chek 3
                <CiReceipt className="mt-1.5 ml-1" />
                </Link>
            </div>
            <input
