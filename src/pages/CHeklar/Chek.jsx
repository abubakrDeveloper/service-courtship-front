...
import { Flex, Splitter, Typography, Button,Input,Select,InputNumber } from "antd";
import {
    SearchOutlined,
    PlusOutlined,
    DeleteOutlined,
...
import Chek2 from "./Chek2";
import Chek3 from "./Chek3";
 ...
 const Chek1 =() => (
    ...
    <Splitter style={{ height: 600, boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)" }}>
        <Splitter.Panel defaultSize="40%" min="20%" max="60%">
            <div className="chek mt-1.5 ml-2.5 flex" >
                <h2 className="text-2xl ml-3  text-emerald-600 text-shadow-lg/15">Chek 1 oynasi</h2>
               <Link className="ml-2.5 text-2xl flex" to="/Chek2">Chek 2
                <CiReceipt className="mt-1.5 ml-1" /></Link>
               <Link className="ml-2.5 text-2xl flex" to="/Chek3">Chek 3
               <CiReceipt className="mt-1.5 ml-1" />
               </Link>
            </div>
          
        <input type="text" className="mt-4.5 ml-5 w-3xs rounded-md border-2"   /> 
        ...
        Search
            ...
            <table className="w-130 rounded-md text-center mt-5 ml-5 border-2 border-solid border-gray-400">
                <thead className="bg-blue-700">
                    <tr>
                        <th className="text-amber-50 border border-gray-300">Rasmi</th>
                        <th className="text-amber-50 border border-gray-300">Tavar Nomi</th>
                        <th className="text-amber-50 border border-gray-300">Miqrodi</th>
                        <th className="text-amber-50 border border-gray-300">Narxi</th>
                        <th className="text-amber-50 border border-gray-300">add</th>
                        <th className="text-amber-50 border border-gray-300">delete</th>
                    </tr>
                </thead>
                <tbody>
                     <tr>
                         <td className="border border-gray-300"><CameraOutlined /></td>
                        ...
                        <td className="border border-gray-300"> <Button type="link"><PlusOutlined /></Button></td>
                        <td className="border border-gray-300"> <Button type="link"><DeleteOutlined /></Button></td>
                     </tr>
                  </tbody>
            </table>
